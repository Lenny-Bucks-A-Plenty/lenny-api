...
class all_three_algos:
    def run_analysis_algos(ticker: str):
        ...
        bollinger_data = bollinger_bands.calculate_bollinger_bands(hist)
        bollinger_signal = bollinger_bands.determine_bollinger_signal(bollinger_data)

        # Calculate Momentum Oscillators
        momentum_data = mom_oscillators.momentum_oscillators(hist)
        momentum_signal = mom_oscillators.determine_momentum_signal(momentum_data)

        # Linear Regression Prediction
        lin_reg_pred = linear_reg.lin_reg(hist)
        lin_reg_signal = linear_reg.determine_linear_reg_signal(lin_reg_pred)
        ...
        confidence = bollinger_signal[1]*.3 + momentum_signal[1]*.3 + lin_reg_signal[1]*.4
...
class testing:
    def main():
        ...
        all_three_algos.run_analysis_algos("MSFT")
